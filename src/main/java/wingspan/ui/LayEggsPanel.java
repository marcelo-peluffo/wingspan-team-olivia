...
public class LayEggsPanel extends JPanel implements KeyListener, MouseListener {
    ...
    public LayEggsPanel() {
        ...
        try {
            ...
            boardImage = ImageIO.read(MainPanel.class.getResourceAsStream("/Images/GameBoard.jpg"));
            background = ImageIO.read(DrawCardsPanel.class.getResourceAsStream("/Images/backgroundImage2.jpeg")); 
